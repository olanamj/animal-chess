/**The class Tiger represents a Tiger piece
 * 
...
{
	/**
	 * This constructor sets the attributes of the Tiger piece
	 * @param red whether the Tiger is a red or blue piece
	 * @param r the initial row location of the Tiger on the board
	 * @param c the initial column location of the Tiger on the board
	 */
	public Tiger(boolean red, int r, int c) {
		super(red,"Tiger",6,r,c);
	}
	
	/**
	 * This method checks where the Tiger can move when there is no other piece on their destination
    ...
    /**
     * This method riverJump sets the conditions for the Tiger to jump across the river
     */
    ...
    /**
     * This method riverJumpMouse sets the conditions for the Tiger to jump across the river if there is a mouse on the river
     */
	...
	/**
     * This method sets the abstract returnRank method to set the rank of this piece to 6
     */
